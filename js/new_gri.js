...
async function fetchDataFor(grtId, siteId) {
  // const API_SERVER = "https://miniature-possess-controlling-outline.trycloudflare.com";
  const API_SERVER = "http://211.34.194.70:9000";
  const url = `${API_SERVER}/sampledata?grtId=${encodeURIComponent(grtId)}&siteId=${encodeURIComponent(siteId)}`;
