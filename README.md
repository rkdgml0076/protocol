...
### 진행 내용
**Month 필드명을 Vermo로 변경**
1. 프로토콜 필드맵 구간이 검침월이 아닌 검정월로 정정
<br>
...
### 진행 내용
**대구시 임시 데이터포맷 작성**
1. F/W Project 대구시 Protocol 개발 보조용으로 미리 데이터포맷 작성
2. 상세 파싱 내용은 대구시 Protocol 개발과 동시에 업데이트 예정
--Image 참고--<br>
<img width="1208" height="953" alt="Image" src="https://github.com/user-attachments/assets/c5f39e3b-47ab-4ce1-bb36-88d13f6d93fe" />
<br>

---


### 2026-07-08 GitHub Commit
#### 본 사이트를 개발하기위한 기본 작업 환경 
## 작업 환경 설정
- 개발 환경(Code Editer) Visual Studio Code 사용 <br>
- index.html을 초기 페이지로 설정
...
### 진행 내용
**검침 데이터 파싱 추가**
1. 대구시 계량기 프로토콜 연구가 불씨가 되어 UART로 읽어오는 데이터의 원활한 해석을 위해 검침 데이터 필드 추가 
2. 서울시, 대구시 계량기 프로토콜 추가
3. 약어코드 51개 제조사 정보 추가
